...
export BUILD_TAG="EMB3531_6.6.y_${set_rootfs}"
...
wget -c https://github.com/yifengyou/EMB3531/releases/download/ophub_6.6.y_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/EMB3531/releases/download/ophub_6.6.y_kernel/config-6.6.y-kdev
ls -alh config-6.6.y-kdev
md5sum config-6.6.y-kdev

wget -c https://github.com/yifengyou/EMB3531/releases/download/ophub_6.6.y_kernel/System.map-6.6.y-kdev
ls -alh System.map-6.6.y-kdev
md5sum System.map-6.6.y-kdev

wget -c https://github.com/yifengyou/EMB3531/releases/download/ophub_6.6.y_kernel/rk3399-emb3531.dtb
ls -alh rk3399-emb3531.dtb
md5sum rk3399-emb3531.dtb

wget -c https://github.com/yifengyou/EMB3531/releases/download/ophub_6.6.y_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
