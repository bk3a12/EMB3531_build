...
export BUILD_TAG="EMB3531_stable_${set_rootfs}"
...
wget -c https://github.com/yifengyou/EMB3531/releases/download/linux_stable_kernel/Image
ls -alh Image
md5sum Image

wget -c https://github.com/yifengyou/EMB3531/releases/download/linux_stable_kernel/config-7.0-kdev
ls -alh config-7.0-kdev
md5sum config-7.0-kdev

wget -c https://github.com/yifengyou/EMB3531/releases/download/linux_stable_kernel/System.map-7.0-kdev
ls -alh System.map-7.0-kdev
md5sum System.map-7.0-kdev

wget -c https://github.com/yifengyou/EMB3531/releases/download/linux_stable_kernel/rk3399-emb3531.dtb
ls -alh rk3399-emb3531.dtb
md5sum rk3399-emb3531.dtb

wget -c https://github.com/yifengyou/EMB3531/releases/download/linux_stable_kernel/kos.tar.gz
ls -alh kos.tar.gz
md5sum kos.tar.gz
tar -xf kos.tar.gz
