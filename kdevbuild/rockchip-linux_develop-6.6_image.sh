...
label l0
	...
	append root=/dev/mmcblk0p3 rootwait rw console=ttyS2,115200 console=tty1 cgroup_enable=cpuset cgroup_memory=1 cgroup_enable=memory net.ifnames=0 biosdevname=0 level=10 loglevel=10 selinux=0 crashkernel=384M-:128M systemd.mask=systemd-growfs@-.service rockchip.dmc_freq=528000 video=HDMI-A-1:1920x1080@60
...
label l0r
	...
	initrd initrd.img-6.6-kdev
	fdt /dtb/rk3399-emb3531.dtb
	append root=/dev/mmcblk0p3 rootwait rw console=ttyS2,115200 console=tty1 cgroup_enable=cpuset cgroup_memory=1 cgroup_enable=memory net.ifnames=0 biosdevname=0 level=10 loglevel=10 selinux=0 crashkernel=384M-:128M single
